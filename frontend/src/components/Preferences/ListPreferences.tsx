              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.tone}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>Style</p>
                    <p className={'line-clamp-2'}>{item.style}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>PreferredTopics</p>
                    <p className={'line-clamp-2'}>{item.topics}</p>
                  </div>
...
export default ListPreferences;
