...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.companies_organization =
      await organizations.getCompanies_organization({
        transaction,
      });
    ...
    output.posts_organization = await organizations.getPosts_organization({
      transaction,
    });

    output.preferences_organization =
      await organizations.getPreferences_organization({
        transaction,
      });
