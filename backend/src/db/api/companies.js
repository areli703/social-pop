...
module.exports = class CompaniesDBApi {
  static async create(data, options) {
    ...
    await companies.setOrganization(currentUser.organization.id || null, {
      transaction,
    });
  ...
  static async update(id, data, options) {
    ...
    await companies.setOrganization(
  ...
  static async findBy(where, options) {
    ...
    output.organization = await companies.getOrganization({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    if (filter) {
      ...
      if (filter.email) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('companies', 'email', filter.email),
        };
      }
